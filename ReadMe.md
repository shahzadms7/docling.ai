# Docling AI
## Local Knowledge Workbench — Master Blueprint, Build Guide, Command Center, and Long-Term Operating Manual

> **Single authoritative master document**  
...
If you want one single file only for now, use **README.md** as the master and add other files later.
